...
interface PartsAndEquipamentsCardProps{
    isToAdd: boolean
    component: IPartsAndEquipaments
    changeComponentsCard: () => void
    changeViewAlertCard: (children:ReactNode, hasButton:boolean) => void
    refresh: () => void
}

export function PartsAndEquipamentsCard({isToAdd, component, changeComponentsCard, changeViewAlertCard, refresh}: PartsAndEquipamentsCardProps){

    const [componentName, setComponentName] = useState(component.application)
    const [componentQtd, setComponentQtd] = useState(component.qtd)
    const [componentQtdMin, setComponentQtdMin] = useState(component.model)
    const [componentLocal, setComponentLocal] = useState(component.brand)
    const [componentDescription, setComponentDescription] = useState(component.type)
